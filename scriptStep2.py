...
url = "https://cours-cloud-473712.ew.r.appspot.com/api/timeline?user=user1&limit=20"

param = 100 #We change the parameter here to match the number per user.
concurrency = 50 #-c
total_requests = 50 #-n
runs = 3

csv_file = "out/post2.csv" #path to the csv exit file
